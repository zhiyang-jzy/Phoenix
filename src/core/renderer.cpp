...
PHOENIX_NAMESPACE_BEGIN
    ...
    void Renderer::Render() {
        ...
        spdlog::info("Time Token {} seconds",
                     std::chrono::duration_cast<std::chrono::seconds>(pre_end - pre_start).count());
        ...
        spdlog::info("Time Token {} seconds",
                     std::chrono::duration_cast<std::chrono::seconds>(stop_time_ - start_time_).count());
